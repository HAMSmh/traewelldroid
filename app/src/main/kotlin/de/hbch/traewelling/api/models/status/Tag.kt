...
enum class TagType {
    ...
    @SerializedName("trwl:journey_id")
    JOURNEY_ID {
        override val icon = R.drawable.ic_code
        override val title = R.string.tag_journey_id_title
        override val key = "trwl:journey_id"
        override val example = R.string.tag_journey_id_example
    },
